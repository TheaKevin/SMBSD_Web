            ...
            <div class="modal-body">
                ...
                <form action="{{ route('login') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="mb-3 form-control @error('loginID') is-invalid @enderror"
                            type="text"
                            name="loginID"
                            id="loginID"
                            placeholder="loginID">
...
<script type="text/javascript">
    @if( ($errors->has('loginID') == 1 || $errors->has('password') == 1) || Session::has('loginError'))

        @if($errors->has('loginID') == 1)
            document.getElementById('loginID').classList.remove('mb-3');
        @endif
